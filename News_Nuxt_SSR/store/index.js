...
export const mutations = {
    ...
    saveAdmininfo: function (state, admin) {
        state.adminID = admin.adID;
        state.adminName = admin.adName;
    },
...
export const actions = {
    ...
    saveadmin: function (context, admin) {
        context.commit("saveAdmininfo", admin);
    },
